...
import { createClassEntity, createTypeAliasEntity } from "unwritten:interpreter/ast/entities/index";
...
import type { ObjectType, TypeLiteralType } from "unwritten:interpreter:type-definitions/types";
