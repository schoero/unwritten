...
scope("Renderer", EntityKind.Function, () => {

  {
    ...
    const renderedFunctionForTableOfContents = convertFunctionEntityForTableOfContents(ctx, testFunction as FunctionEntity);
    const renderedFunctionForDocumentation = convertFunctionEntityForDocumentation(ctx, testFunction as FunctionEntity);
